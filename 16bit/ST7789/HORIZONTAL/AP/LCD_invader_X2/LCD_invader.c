...
//	printstr(64,80,7,0,"SPACE ALIEN");
	printstr(64+48,80,7,0,"SPACE ALIEN");
//	printstr(48,110,7,0,"PUSH START BUTTON");
	printstr(48+40,110,7,0,"PUSH START BUTTON");
	while(1){
		//STARTキー待ち
		keycheck();
...
//	printnum2(16,304,7,0,score,5);
	printnum2(248,72,7,0,score,5);
//	printnum2(136,304,7,0,highscore,5);
	printnum2(248,24,7,0,highscore,5);
}
void putzanki(void){
//自機残数表示
	int i;
...
//	printstr(74,130,4,0,"GAME OVER");
	printstr(74+40,130,4,0,"GAME OVER");
...
//	printstr(16,296,5,0,"SCORE");
	printstr(248,64,5,0,"SCORE");
//	printstr(128,296,2,0,"HI-SCORE");
	printstr(240,16,2,0,"HI-SCORE");
